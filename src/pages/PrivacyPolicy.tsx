    ...
    <Layout>
      ...
      >
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Your privacy matters to us. This page outlines how Cefalu Car Rental collects, uses, and protects your information.
        </p>
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          If you have questions about this privacy policy, please contact us at <a href="mailto:info@cefalu-car-rental.com" className="text-primary hover:underline">info@cefalu-car-rental.com</a>.
        </p>
      </Section>
    </Layout>
  );
